...
//This is for the Snake Scan
SETUPDXDY:
    // Set up the DX and DY and SwS state 
    MOV DX, dx
    MOV DY, dy
    MOV SwS, 0
...
RLOOP3:
    ...
    QBEQ SWitchN, SwS, 0    // check state of SWS update inverted DX and DY
    QBEQ SWitchP, SwS, 1    // check state of SWS update inverted DX and DY

    //Need to switch change sign of dy and dx  if we are in the fast axis
